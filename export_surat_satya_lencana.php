...
// Query untuk mengambil data dari tabel kenaikan_pangkat
$query = "SELECT 
    k.*,
...
$pangkat_pegawai = $data['pangkat_baru'];
$golongan_pegawai = $data['golongan_baru'];
$jabatan_pegawai = $data['jabatan_baru'];

// Data Surat Keputusan (gunakan tanggal_usul jika ada, atau tanggal sekarang)
$nomor_sk = !empty($data['nomor_sk']) ? $data['nomor_sk'] : '___/___/___';
$tanggal_sk = !empty($data['tanggal_sk']) ? $data['tanggal_sk'] : date('Y-m-d');
...
$thn_sk = date('Y', strtotime($tanggal_sk));

// Tanggal surat sekarang
...
<head>
    <meta charset="utf-8">
    <title>Surat Pernyataan Melaksanakan Tugas</title>
    <style>
        @page {
            size: A4;
...
<body>
    <div class="page">
        ...
        <div class="header-wrapper">
            ...
            <div class="header-text">
                ...
                <p class="header-line3">E-mail : dppkbpm@gmail.banjarmasin.go.id, website http://dppkbpm.banjarmasinkota.go.id</p>
            </div>
        </div>
        ...
        <!-- TITLE -->
        <div class="title">
            <p class="title-line1">SURAT PERNYATAAN MELAKSANAKAN TUGAS</p>
        </div>

        <!-- NOMOR SURAT -->
        <p class="nomor-surat">
            Nomor : 800.1.13.1/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/DPPKBPM-BJM/<?= $tahun_sekarang ?>
        </p>
            ...
            <div class="data-block">
                <table>
                    ...
                    <tr>
                        <td class="label">Pangkat / Golongan</td>
                        <td class="colon">:</td>
                        <td><?= htmlspecialchars($pangkat_pegawai) ?> / <?= htmlspecialchars($golongan_pegawai) ?></td>
                    </tr>
                    <tr>
                        <td class="label">Jabatan</td>
                        <td class="colon">:</td>
                        <td><?= htmlspecialchars($jabatan_pegawai) ?></td>
                    </tr>
                </table>
            </div>

            <p>Yang diangkat berdasarkan Surat Keputusan Walikota Nomor <?= htmlspecialchars($nomor_sk) ?>, Diklat Tanggal <?= $tgl_sk ?> <?= $bln_sk ?> <?= $thn_sk ?>, telah nyata melaksanakan tugas sebagai <?= htmlspecialchars($jabatan_pegawai) ?> Dinas Pengendalian Penduduk Keluarga Berencana dan Pemberdayaan Masyarakat Kota Banjarmasin.</p>

            <p>Demikian Surat Pernyataan melaksanakan tugas ini dibuat dengan sesungguhnya dengan mengingat sumpah jabatan Pegawai Negeri Sipil dan apabila dikemudian hari isi surat keterangan ini ternyata tidak benar yang mengakibatkan kerugian Negara maka saya bersedia menanggung kerugian tersebut.</p>
        </div>

        <!-- SIGNATURE AREA -->
        <table style="width: 100%; font-size: 11pt; margin-top: 30px;">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <!-- Kosong untuk seimbang -->
                </td>
                <td style="width: 50%; text-align: center; vertical-align: top;">
                    <p style="margin: 2px 0; line-height: 1.3;">Banjarmasin, <?= $tanggal_sekarang ?> <?= $bulan_sekarang ?> <?= $tahun_sekarang ?></p>
    ...
    <div class="no-print button-container">
        <h3>🏅 Surat Pernyataan Melaksanakan Tugas (Satya Lencana)</h3>
