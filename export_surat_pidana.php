...
<head>
    <meta charset="utf-8">
    <title>Surat Pernyataan Tidak Pernah Dijatuhi Hukuman Disiplin</title>
    <style>
        @page {
            size: A4;
...
<body>
    <div class="page">
        ...
        <!-- TITLE -->
        <div class="title">
            <p class="title-line1">SURAT PERNYATAAN</p>
            <p class="title-line2">TIDAK PERNAH DIJATUHI HUKUMAN DISIPLIN TINGKAT SEDANG/BERAT</p>
        </div>
            ...
            <div class="data-block">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="colon">:</td>
                        <td>Dinas Pengendalian Penduduk Keluarga Berencana<br>dan Pemberdayaan Masyarakat</td>
                    </tr>
                </table>
            </div>

            <p>Dalam satu tahun tidak pernah dijatuhi hukuman disiplin tingkat sedang atau berat.</p>
    ...
    <div class="no-print button-container">
        <h3>📄 Surat Pernyataan Tidak Pernah Dijatuhi Hukuman Disiplin</h3>
